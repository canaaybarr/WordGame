...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        /// <summary>
        /// Method to draw rectangles around each wordCellX of the text.
        /// </summary>
        /// <param name="text"></param>
        void DrawWordBounds()
        {
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                // Iterate through each character of the wordCellX
        ...
        void DrawBounds()
        {
            ...
            // Get Bottom Left and Top Right position of each wordCellX
